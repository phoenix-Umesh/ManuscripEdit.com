    ...
    <>
      ...
      <div className="col-lg-10 col-md-10 col-sm-10 pt-5 mx-auto">
        <p className="text-center widfont">
          ...
          love to have your feedback by e-mail. Alternatively, you may leave a
     ...
     <div className="modal-dialog formm">
         <div className="modal-content">
             <div className="modal-header headbg">
                 <h5 className="modal-title" id="exampleModalLabel">Request a follow up</h5>
             </div>
                 ...
                 <div className="card-content p-2">
                     ...
                     <div className="row marB0">
                         <div className="form-group col-lg-6 col-md-6">
                             <label for="name" className="label2">First Name *</label>
                             <input name="student_name" id="name" type="text" className="form-control" required="">

                         </div>
                         <div className="form-group col-lg-6 col-md-6">
                             <label for="name" className="label2">Last Name *</label>
                             <input name="student_name" id="name" type="text" className="form-control" required="">

                         </div>

                         <div className="form-group col-lg-6 col-md-6">
                             <label for="mobile" className="label2">Prefered Email id *</label>
                             <input onkeydown="return isNumber(event);" id="mobile" type="text" name="mobile"
                                 className="form-control EnquiryMobile" required="">

                         </div>
                         <div className="form-group col-lg-6 col-md-6">
                             <label for="mobile" className="label2">Phone *</label>
                             <input onkeydown="return isNumber(event);" id="mobile" type="text" name="mobile"
                                 className="form-control EnquiryMobile" required="">
                         ...
                         <div className="form-group col-lg-6 col-md-6">
                             <label for="email" className="label2">Profession *</label>
                             <input name="email" id="email" type="email" className="form-control" required="">

                         </div>

                         <div className="form-group col-lg-6 col-md-6">
                             <label for="course" className="label2">Country *</label>
                             <select name="course" id="course" className="form-control w-100" required="" style="">
                         ...
                         <div className="form-group col-lg-6 col-md-6">
                             ...
                             <input required="" name="city" id="place" type="text" className="form-control big-box">
             ...
             <div className="modal-footer footbg">
                 <button type="button" className="btn btn-primary over">Send</button>
             </div>
         </div>
     </div>
     ...
     <div className="formmm">
         <ul className="contactdetail">
             <li className="ulli"><img src="images/telegram.png">&nbsp;&nbsp;<b>Telegram&nbsp;:</b>&nbsp;+91-904-000-5445
             </li>

             <li className="ulli"><img src="images/logoWhatsapp.png">&nbsp;&nbsp;<b>WhatsApp&nbsp;:</b>&nbsp;&nbsp; +1
                 (646)916-3476
                 &nbsp;&nbsp;(USA)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+91-904-002-3003
                 (India)</li>

             <li className="ulli"><img src="images/email.webp">&nbsp;&nbsp;<b>Email
                     id&nbsp;:</b>&nbsp;support@manuscriptedit.com</li>
         </ul>
     </div>
